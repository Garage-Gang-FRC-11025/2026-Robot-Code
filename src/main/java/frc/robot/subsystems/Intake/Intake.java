...
public class Intake extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if (rKP.hasChanged(hc) || rKD.hasChanged(hc) || rollerTargetAccelerationConfig.hasChanged(hc))
      configRoller();
  ...
  private void configRoller() {
    ...
    intakeIO.configRoller(rKD.get(), rKP.get(), rollerTargetAccelerationConfig.get());
  }
